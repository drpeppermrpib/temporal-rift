...
| Ashen Warden companion sprites | **Drafted on master, flag OFF** (`WARDEN_SPRITE_ENABLED=false`; live procedural figure; flip â†’ drawH=48, r=13 unchanged) â€” ally **#3b** Warden art; weathered yellow knight-robotics; commit **`4c66510`**; **no APK / no version bump / no articulation yet** | **No** | **No** | **No** |
...
- **Master later (unreleased; still 2.13.2 / vc46, no APK):** Ashen Warden â€” sheets drafted; `WARDEN_SPRITE_ENABLED=false` (r=13 / drawH=48); yellow knight-robotics mesh; articulate later. Ally #3b partial; Scout/Sentinel pending.
