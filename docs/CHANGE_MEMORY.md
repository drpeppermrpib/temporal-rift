...
- **Master later (unreleased; still 2.13.2 / vc46, no APK):** Ashen Rover / Rift Hound — sheets + articulation+barks (`4b9b2ea`); `ROVER_SPRITE_ENABLED=true` for Continuity testing (r=11 / drawH=26); store ship deferred. Ally #3a; #3b next.
