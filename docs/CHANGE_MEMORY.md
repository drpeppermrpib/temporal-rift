...
- **Master later (unreleased; still 2.13.2 / vc46, no APK):** Ashen Warden — sheets + articulation+barks (**abe9e02** + docs **2114ce3** / **a55db1e**); `WARDEN_SPRITE_ENABLED=true` for Continuity testing (r=13 / drawH=48); store ship deferred. Ally #3b Warden done; Scout/Sentinel pending.
