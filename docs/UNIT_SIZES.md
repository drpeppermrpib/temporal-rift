...
- **Rift Keep (art drafted, flag OFF 2026-08-09):** `assets/buildings/keep/{idle,damaged}.png`; `KEEP_SPRITE_ENABLED=false` (live procedural keep bw42/bh40/~56 tall). Flip flag -> `drawH=72`, collision `r=54` unchanged (keep-sized, not Gharok-huge). Halls/camps pending. See `docs/keep-art-plan.md`.
