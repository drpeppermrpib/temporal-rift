...
### 2026-08-09 â€” DEFERRED â€” Ashen Bulwark art drafted (APK apply later)
...
- Agent action: Generated original Ashen Bulwark / Rift Brute idle/walk/windup; size lock `r=20` / `drawH=52.2` (36Ã—1.45); soft-wire behind `BULWARK_SPRITE_ENABLED=false`; docs + Desktop preview; CHANGE_MEMORY append
- Notes: Ready for NPC #3 shaman/ravager. Flip flag + BETA when applying. No WoW/Blizzard/Warhammer IP.

### 2026-08-09 â€” DEFERRED â€” Ashen Skeleton art drafted (APK apply later)
...
- Agent action: Generated original Ashen Skeleton idle/walk/windup; size lock `r=10` / `drawH=32.4` (36Ã—0.9); soft-wire behind `SKELETON_SPRITE_ENABLED=false`; docs + Desktop preview; CHANGE_MEMORY append
- Notes: Ready for next NPC refs. Flip flag + BETA when applying. No WoW/Blizzard/InkWell IP.

### 2026-08-09 â€” SHIPPED â€” v2.12.1 Ashen Husk detailed sprites (small footprint)
- Version / commit / APK: 2.12.1 (versionCode 43) / `2454291` / BETA `TemporalRift-BETA-2.12.1.apk`
- User intent: Make zombies the same way as Gharok (detailed sprite art from refs); rest of zombie polish next part; **CRITICAL:** keep current small husk size â€” Gharok pipeline = quality only, not boss `r=54` / `drawH=228`
...
### 2026-08-08 â€” SHIPPED â€” v2.12.0 in-engine unit animation finish (sizes locked)
...
- Agent action: Finished Gharok idle/walk/attack(windup+strike)/hurt lean on existing sheets + procedural fallback; additive limb-flow walk/attack/hurt for enemies + allies + laborers/militia/Colossus; locked radii/draw scales in `docs/UNIT_SIZES.md`; noted Pixelorama/Forge deferred â€” primary = in-engine
...
### 2026-08-08 â€” SHIPPED â€” Windows character-drop pipeline (docs + folder)
...
- Notes: **Rift Forge APK deferred for ease** â€” Windows drop pipeline preferred for v3 art. ComfyUI/AnimateDiff optional drafts only. Next: artist drops sheets â†’ agent wires one unit sheet player.

### 2026-08-08 â€” DEFERRED â€” Rift Forge APK expansion for day-to-day skins
- Version / commit / APK: n/a (companion path)
- User intent: Skins/characters easier than Forge APK
- Agent action: Do not expand Forge APK; document simpler Windows editor â†’ `character-drops` handoff instead
- Notes: Forge scaffold remains; v3 overhaul still deferred. Prefer Pixelorama/LibreSprite locally.

### 2026-08-08 â€” SHIPPED â€” v2.11.0 WC2-inspired RTS overhaul slice
- Version / commit / APK: 2.11.0 (versionCode 41) / `740e93a` / BETA `TemporalRift-BETA-2.11.0.apk`
- User intent: Warcraft-2â€“inspired additive overhaul (~2hr playable slice): town buildings, choppable forests, gold mines, workersâ‰ squad, Muster +3/wave fighters, click orders/skills, expanded map; original names only; keep wave survival
- Agent action: Map 3600â†’4800; forest stands + gold mine buildings; Rift Keep / Supply Camp / Gold Vault + existing halls; Ashen Laborers worker-only with Chop/Mine/Follow orders; Muster Spearmen/Bowmen (+3 train/wave, revivable); light fighter skill nodes; starter Keep+2 laborers + tips; HUD worker/squad counts; kept companions/barricades/mend/revive/learning/BETA id; no Play Console; no Rift Forge v3
...
### 2026-08-08 â€” SHIPPED â€” Rift Forge companion scaffold (sibling project)
- Version / commit / APK: Forge 0.1.0 / sibling repo `videogamemakes/rift-forge` / `rollouts/RiftForge-0.1.0.apk`
- User intent: Companion APK/web workshop for 2D kits â†’ Drive â†’ later Temporal Rift v3; not a Tripo 3D clone
...
### 2026-08-08 â€” DEFERRED â€” Rift Forge companion started; v3 overhaul pending
...
- Agent action: Thin memory note only â€” no gameplay/APK ship this entry
- Notes: Do not treat as SHIPPED remove/keep; overhaul deferred until explicitly ordered

### 2026-08-08 â€” SHIPPED â€” v2.10.0 additive RTS build picker slice
...
- Notes: Buildable city pathway moved from deferredâ†’started. discoverability_risk: Colossus needs 2 nearby allies + resources (button + Key C). No Play Console upload. Boss art skipped.

### 2026-08-08 â€” SHIPPED â€” v2.9.3 hide learning / one-tap mend / wall ghost
...
- Agent action: Settings `adaptHidden` toggle (persisted); field MEND btn + Key H (`tryAetherMend`, same costs as infirmary); barricade aim ghost + link lines/`LINK Ã—N` before place; kept 2.9.2 field Talk revive
...
### 2026-08-08 â€” SHIPPED â€” change memory system
...
### 2026-08-08 â€” KEPT â€” baseline chat audit immutable
...
### 2026-08-08 â€” DEFERRED â€” OnePlus 9 Pro / Evolution X bug (unknown)
...
### 2026-08-08 â€” DEFERRED â€” co-op combat sync / buildable city / polish backlog
- Version / commit / APK: n/a (pending)
- User intent: From audit misses â€” full enemy sync; buildable city; hide learning toggle; one-tap mend; wall preview; channel catch-up
- Agent action: Listed under Pending in CHANGE_MEMORY
- Notes: Boss art / feel polish skipped unless user reopens

### 2026-08-08 â€” SHIPPED â€” v2.9.2 field squad revive + PeerJS downed revive
- Version / commit / APK: 2.9.2 / `dd08d2d` / BETA APK
- User intent: â€œRevive squad gone?â€ + MP revive
...
### 2026-08-08 â€” SHIPPED â€” v2.9.1 compact HUD + thinner beam
...
### 2026-08-07 â€” SHIPPED â€” v2.9.0 infirmary, fortify links, Riftnet foundation
...
### 2026-08-07 â€” SHIPPED â€” v2.8.7 sound + world sprites
- Version / commit / APK: 2.8.7
- User intent: Sound engine submenu; sprite pines/rocks
- Agent action: Shipped
- Notes: â€”

### 2026-08-06 â€” SHIPPED â€” v2.8 BETA package + systems
...
- Notes: Store/GitHub stayed behind (~2.6) â€” OPS lag

### 2026-08-06 â€” OPS â€” public channels held at ~2.6
...
- Notes: Channel lag â‰  code regression

### 2026-08-06 â€” SHIPPED â€” v2.7 content (shelf)
...
### 2026-08-06 â€” SHIPPED â€” v2.6 HUD / layout / vibration
...
### 2026-08-05 â€” REMOVED â€” center â€œENTERINGâ€ city popup
- Version / commit / APK: v2.4
- User intent: Remove center popup; keep bottom label
- Agent action: Removed; bottom `regionFlashT` kept
- Notes: Still removed as of 2.9.2 â€” do not re-add

### 2026-08-05 â€” KEPT / SHIPPED â€” Play must not get GitHub update banner
...
- Notes: True regression-class bug if this gate breaks â€” keep gated
